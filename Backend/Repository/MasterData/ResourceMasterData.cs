...
namespace Backend.Repository.MasterData
{
    public class ResourceMasterData : IResourceMasterData
    {
        private WBCContext _DBContext;
        private IApprovalSetup _approvalSetupRepo;

        public ResourceMasterData(WBCContext dBContext, IApprovalSetup approvalSetupRepo)
        {
